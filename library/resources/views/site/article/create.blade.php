...
@section('page-header')
				<!-- breadcrumb -->
					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Forms</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ create</span>
...
@section('content')
				<!-- row -->
				<div class="row">
					<div class="bg-gray-200" style="min-width: 40%">
					...
					@endif
						...
						<div class=" mg-b-20">
							...
							<div class="">
								<textarea class="form-control" placeholder="content" name="content" cols="20"  rows="8"></textarea>
							</div>
						</div>
						<div class=" mg-b-20">
							<h2>cover</h2>
