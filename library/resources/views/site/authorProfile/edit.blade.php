									...
									<div class="main-profile-overview">
										...
										<div class="row">
											...
											<div class="col-md-4 col mb20">
												...
												<h6 class="text-small text-muted mb-0">articles</h6>
											</div>
										</div>
										<hr class="mg-y-30">
								...
								{{-- 	<div class="form-group ">
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea name="about" class="form-control" name="example-textarea-input" rows="4" placeholder="">{{ $user->about->about }} </textarea>
											</div>
										</div>
									</div>
