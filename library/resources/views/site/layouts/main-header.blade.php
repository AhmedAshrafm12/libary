					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									...
									<div class="main-message-list chat-scroll">
										<a href="#" class="p-3 d-flex border-bottom">
											<div class="  drop-img  cover-image  " data-image-src="/storage/{{Auth::user()->avatar}}">
							...
							<div class="dropdown nav-item main-header-notification">
								<a class="new nav-link" href="#" id="ring">
								<svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg><span class="pulse" id="pulse" style="display: {{ hasNewNotifications() == 1 ? 
								"block" : "none" }}"></span></a>
								<div class="dropdown-menu" id="">
									...
									<div class="main-notification-list Notification-scroll" id="notifis">
										{{-- <p></p> --}}
										@foreach (Auth::user()->notifications as $notifi )
										<a class="d-flex p-3 border-bottom" href="{{ $notifi->link }}">
											<div class="notifyimg bg-pink">
												<i class="la la-file-alt text-white"></i>
											</div>
											<div class="mr-3">
												<h5 class="notification-label mb-1">{{ $notifi->massage }}</h5>
												<div class="notification-subtext">{{ $notifi->created_at   }}</div>
											</div>
											<div class="mr-auto" >
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt=""  src="/storage/{{Auth::user()->avatar}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="/storage/{{Auth::user()->avatar}}" class=""></div>
											<div class="mr-3 my-auto">
												<h6>{{ Auth::user()->userName }}</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href="/profile/{{ Auth::user()->id }}"><i class="bx bx-user-circle"></i>Profile</a>
									<a class="dropdown-item" href="/editProfile/{{ Auth::user()->id }}"><i class="bx bx-cog"></i> Edit Profile</a>
