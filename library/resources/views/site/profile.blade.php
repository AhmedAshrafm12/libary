								...
								<div class="pl-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											<img alt="" src="/storage/{{Auth::user()->avatar}}"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
										</div>
										...
										<div class="main-profile-social-list">
											<div class="media">
												...
												<div class="media-body">
													<span>email</span> <a href="">{{ Auth::user()->email }}</a>
												</div>
											</div>
											<div class="media">
												...
												<div class="media-body">
													<span>mobile</span> <a href="">{{ Auth::user()->mobile }}</a>
												</div>
											</div>
							...
							<div class="card-body">
								...
								<div class="tab-content border-left border-bottom border-right border-top-0 p-4">
									<div class="tab-pane active" id="home">
										...
										<p class="m-b-5">{{ Auth::user()->about->about }}</p>
										<div class="m-t-30">
								
												<p><b>{{ Auth::user()->registrationDate }}</b></p>
