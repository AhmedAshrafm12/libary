								...
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="view/{{$book->file}}/{{ $book->id }}">{{$book->name}}</a></td>
                                            <td>{{$book->description}}</td>

                                            <td>{{$book->user->userName}}</td>
                                            <td>{{$book->updated_at}}</td>
                                            <td>
												<a class="btn ripple btn-success" href="/admin/approveBook/{{ $book->id }}" href="">approve</a>
												<a class="btn ripple btn-danger" href="/admin/approveBook/{{ $book->id }}" href="">decline</a>
											</td>
