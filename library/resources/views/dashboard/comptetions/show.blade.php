										...
										<div class="bg-gray-200 p-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row mg-t-10">
                                                   ...
                                                   <div class="col-lg-3">
                                                    <label class="rdiobox"><input class="answerSelect" data-answer="{{ $answer->id }}" data-question="{{ $answer->question_id }}" name="rdio{{ $question->id }}" type="radio"> <span>{{ $answer->answer }}</span></label>
                                                </div>
                                                   @endforeach
                                            ...
                                            <input type="hidden" name="comptetion" value="{{ $comptetion->id }}">
