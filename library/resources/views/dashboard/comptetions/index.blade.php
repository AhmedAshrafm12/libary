								...
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="/admin/comptetions/{{ $comptetion->id }}">{{$comptetion->title}}</a></td>
                                            <td>{{$comptetion->description}}</td>

                                            <td>{{$comptetion->user->userName}}</td>
                                            <td>{{$comptetion->created_at}}</td>
                                            <td>
												<a class="btn ripple btn-success" href="/admin/approvecomptetion/{{ $comptetion->id }}" href="">approve</a>
												<a class="btn ripple btn-danger" href="/admin/declinecomptetion/{{ $comptetion->id }}" href="">decline</a>
											</td>
{{--                                             <td><a class="btn ripple btn-success"  href=""> comptetions</a>
 --}}											</td>
