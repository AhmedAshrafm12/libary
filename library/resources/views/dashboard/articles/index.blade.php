								...
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="/admin/articles/{{ $article->id }}">{{$article->subject}}</a></td>
                                            ...
                                            <td>
												<a class="btn ripple btn-success" href="/admin/approvearticle/{{ $article->id }}" href="">approve</a>
												<a class="btn ripple btn-danger" href="/admin/declinearticle/{{ $article->id }}" href="">decline</a>
											</td>
{{--                                             <td><a class="btn ripple btn-success"  href=""> articles</a>
 --}}											</td>
